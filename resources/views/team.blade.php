...
<body>
  <div class="wrapper">
          ...
          <div class="container">
              ...
              <div class="collapse navbar-collapse" id="mainNavigation">
                  <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav__item with-dropdown">
                          <a href="{{route('team')}}" class="dropdown-toggle nav__item-link active">{{ __('index.team') }}</a>
                      </li><!-- /.nav-item -->
                      <li class="nav__item with-dropdown">
    ...
    <section id="page-title" class="page-title page-title-layout1 text-center bg-overlay bg-overlay-2 bg-parallax">
      <div class="bg-img"><img src="/images/backgrounds/8.jpg" alt="background"></div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            <span class="pagetitle__subheading">Ready To Serve</span>
            <h1 class="pagetitle__heading">Our Chefs</h1>
          </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
    </section><!-- /.page-title -->
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
            <div class="heading heading-layout2 text-center mb-40">
              <h2 class="heading__title">Our Talented Chefs</h2>
              <p class="heading__desc">Babette was the first restaurant to open in Egypt, the resturant was designed
                with the history in mind we have created a soft industrial dining room, combined with an open kitchen,
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-4 col-lg-4">
            <div class="member">
              ...
              <div class="member__info">
                <h5 class="member__name">Kevin Dawn</h5>
          ...
          <div class="col-sm-6 col-md-4 col-lg-4">
            <div class="member">
              ...
              <div class="member__info">
                <h5 class="member__name">Marian Peterson</h5>
                <p class="member__desc">Master Chef</p>
              </div><!-- /.member-info -->
            </div><!-- /.member -->
          </div><!-- /.col-lg-4 -->
          <!-- Member #3 -->
          <div class="col-sm-6 col-md-4 col-lg-4">
            <div class="member">
              ...
              <div class="member__info">
                <h5 class="member__name">James Wane</h5>
                <p class="member__desc">Thai Master Chef</p>
              </div><!-- /.member-info -->
            </div><!-- /.member -->
          </div><!-- /.col-lg-4 -->
          <!-- Member #4 -->
          <div class="col-sm-6 col-md-4 col-lg-4">
            <div class="member">
              ...
              <div class="member__info">
                <h5 class="member__name">Madlien Smith</h5>
                <p class="member__desc">Chinese Master Chef</p>
              </div><!-- /.member-info -->
            </div><!-- /.member -->
          </div><!-- /.col-lg-3 -->
          <!-- Member #5 -->
          <div class="col-sm-6 col-md-4 col-lg-4">
            <div class="member">
              ...
              <div class="member__info">
                <h5 class="member__name">Martin Hope</h5>
                <p class="member__desc">Chef Assistant</p>
              </div><!-- /.member-info -->
            </div><!-- /.member -->
          </div><!-- /.col-lg-3 -->
          <!-- Member #6 -->
          <div class="col-sm-6 col-md-4 col-lg-4">
            <div class="member">
              <div class="member__img">
                <img src="/images/team/6.jpg" alt="member img">
                <div class="member__hover">
                  <div class="member__content-inner">
                    <ul class="social__icons justify-content-center list-unstyled">
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
              ...
              <div class="member__info">
                <h5 class="member__name">Jennifer Tom</h5>
                <p class="member__desc">Kitchen Care</p>
              </div><!-- /.member-info -->
            </div><!-- /.member -->
          </div><!-- /.col-lg-4 -->
        </div> <!-- /.row -->
